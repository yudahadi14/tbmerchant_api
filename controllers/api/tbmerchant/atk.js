                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    return models.product_atk.create({
                                        ...
                                        produk_foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/atk/'+filenameproduk+'' || null,
                                    ...
                                    return models.product_header.create({
                                        ...
                                        foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/atk/'+filenametoko+'' || null,
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_atk.create({
                                                ...
                                                produk_kategori_id: kategori_id_produk || null,
                                                produk_kategori_nama: kategori_nama_produk || null,
                                                produk_foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/atk/'+req.files[1].filename+'' || null,
                                            ...
                                            if(dataproduk.length > 0)
                                            {
                                                ...
                                                const savedataproduknoimage = [];
                                                    for(var e=0; e < dataproduk.length; e++)
                                                    {
                                                        ...
                                                        //       produk_foto='${'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/atk/'+filenameprodukk+'' || null}'
