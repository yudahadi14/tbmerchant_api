...
exports.addUserMakanan = (req, res) => {
    try {
                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    return models.product_matrial.create({
                                        ...
                                        produk_foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/matrial/'+filenameproduk+'' || null,
                                    ...
                                    return models.product_header.create({
                                        ...
                                        foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/matrial/'+filenametoko+'' || null,
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_matrial.create({
                                                ...
                                                produk_kategori_id: kategori_id_produk || null,
                                                produk_kategori_nama: kategori_nama_produk || null,
                                                produk_foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/matrial/'+req.files[1].filename+'' || null,
        ...
        // {
        //     //uploadMakanan('tb_merchant/matrial');
        //     return success(req, res, {}, "List Produk Matrial", true);
        // }
                                            ...
                                            if(dataproduk.length > 0)
                                            {
                                                ...
                                                const savedataproduknoimage = [];
                                                    for(var e=0; e < dataproduk.length; e++)
                                                    {
                                                        ...
                                                        //       produk_foto='${'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/matrial/'+filenameprodukk+'' || null}'
