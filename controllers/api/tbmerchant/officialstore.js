...
exports.listUserMakanan = (req, res) => {
    ...
    let { fullname, filterSatu } = req.body;
    ...
    //console.log(filterSatu, filterDua, filterTiga);
        ...
        and (c.produk_kategori_id = :filterSatu  or c.produk_kategori_id = 0)
        and b.kategori_id = 12 order by c.produk_id asc
        `;
            ...
            .then((payload) => {
                ...
                if(cont > 0)
                {
                    ...
                    let query2 = `select
                        ...
                        left join user_login a on a.user_id = b.fk_user_id
                        where user_fullname = :namefull and b.kategori_id = 12
                        `;
...
exports.listUserMakananbyIddevice = (req, res) => {
    ...
    let { iddevice } = req.body;
        ...
        where ud.iddevice = :iddevicee and b.kategori_id = 12 order by c.produk_id desc
        `;
        ...
        return models.sequelize
            ...
            .then((payload) => {
                ...
                if(cont > 0)
                {
                    ...
                    left join user_login a on a.user_id = b.fk_user_id
                    left join user_devicelog ud on ud.fk_userlogin  = a.user_id
                    where ud.iddevice = :iddevicee and b.kategori_id = 12 limit 1
                        `;
            ...
            return models.sequelize
                ...
                .then((payload) => {
                    ...
                    if(cont > 0)
                    {
                        ...
                        from product_header b
                        left join user_login a on a.user_id = b.fk_user_id
                        where user_fullname = :namefull2 and b.kategori_id = 12
                        `;
                        return models.sequelize
                            .query(query2, {
                                replacements: {
                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    return models.product_officialstore.create({
                                        ...
                                        produk_foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/officialstore/'+filenameproduk+'' || null,
                                    ...
                                    return models.product_header.create({
                                        ...
                                        kategori_id: 12,
                                        kategori_nama: 'OFFICIALSTORE' || null,
                                        nama_toko: nama_toko || null,
                                        alamat_toko: alamat_toko || null,
                                        foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/officialstore/'+filenametoko+'' || null,
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_officialstore.create({
                                                ...
                                                produk_kategori_id: kategori_id_produk || null,
                                                produk_kategori_nama: kategori_nama_produk || null,
                                                produk_foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/officialstore/'+req.files[1].filename+'' || null,
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_officialstore.update({
                                                produk_nama: nama_produk || null,
                                                produk_harga: harga_produk,
                                                produk_stok: stok_produk || null,
                                                produk_kategori_id: kategori_id_produk || null,
                                            ...
                                            if(dataproduk.length > 0)
                                            {
                                                ...
                                                const savedataproduknoimage = [];
                                                    for(var e=0; e < dataproduk.length; e++)
                                                    {
                                                        ...
                                                        //       produk_foto='${'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/officialstore/'+filenameprodukk+'' || null}'
                                                        ...
                                                        // return models.product_officialstore.bulkCreate({
                                                        //     produk_nama: dataproduk[e]['nama_produk'] || null,
                                                        //     produk_harga: dataproduk[e]['harga_produk'] || null,
                                                        //     produk_stok: dataproduk[e]['stok_produk'] || null,
                                                        //     produk_kategori_id: dataproduk[e]['kategori_id_produk'] || null,
                                                    ...
                                                    await models.product_officialstore.bulkCreate(
                                                        savedataproduk,
                                                        {
...
exports.deleteUserMakanan = (req, res) => {
    try {
        ...
        if(produk_id)
        {
            return models.product_officialstore.destroy({where: {produk_id: produk_id}})
            .then((userdetail2) => {
                if(userdetail2)
                {
...
exports.cekofficialstore = (req, res) => {
    ...
    try {
        ...
        where ud.iddevice = :iddevice and ul.user_referalcode is not null and ul.user_referalcode  != ''
        `;
        ...
        return models.sequelize
            ...
            .then((payload) => {
                ...
                if(cont > 0)
                {
                    return success(req, res, payload, "Data List Official Store ", true);
...
exports.cekkodereferall = (req, res) => {

    try {

        let { iddevice, kodereferal } = req.body;

        let query = `
        select * from user_marketing where kode_referal = :kodereferal
        `;
        ...
        return models.sequelize
            ...
            .then((payload) => {
                ...
                if(cont > 0)
                {
                    dataheader =
                                                                        {
                                                                            referalkode: kodereferal,
                                                                            iddevice: iddevice
                                                                        }
                                                                    dataheaderquery = `

                                                                    UPDATE user_login set user_referalcode = :referalkode, user_update_date = now()
                                                                    where user_id = (select fk_userlogin from user_devicelog where iddevice = :iddevice
                                                                    and jenisdokumen = 'LOGIN' limit 1)
                                            ...
                                            .catch((err) => {
                                                return error(req, res, {}, "Siahkan Hubungi Marketing Tolong Beliin", false, err);
                                            });


                }else{

                    return error(req, res, {}, "Siahkan Hubungi Marketing Tolong Beliin", false,true);
        ...
        return error(req, res, error, "Siahkan Hubungi Marketing Tolong Beliin", false, err);
    }
