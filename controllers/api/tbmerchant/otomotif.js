                    ...
                    let query2 = `select
                        ...
                        return models.sequelize
                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    return success(req, res, payload2, "List Produk Otomotif", true);
                                }else{
                                    return success(req, res, {}, "List Produk Otomotif", true);
                                }
                            })
                            .catch((err) => {
                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    return models.product_otomotif.create({
                                        ...
                                        produk_foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/otomotif/'+filenameproduk+'' || null,
                                    ...
                                    return models.product_header.create({
                                        ...
                                        foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/otomotif/'+filenametoko+'' || null,
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_otomotif.create({
                                                ...
                                                produk_kategori_id: kategori_id_produk || null,
                                                produk_kategori_nama: kategori_nama_produk || null,
                                                produk_foto: 'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/otomotif/'+req.files[1].filename+'' || null,
                                            ...
                                            if(dataproduk.length > 0)
                                            {
                                                ...
                                                const savedataproduknoimage = [];
                                                    for(var e=0; e < dataproduk.length; e++)
                                                    {
                                                        ...
                                                        //       produk_foto='${'https://production.tolongbeliin.com/tolongbeliinapi/public/upload/tb_merchant/otomotif/'+filenameprodukk+'' || null}'
