...
exports.listUserMakanan = (req, res) => {
    ...
    //console.log(filterSatu, filterDua, filterTiga);
        ...
        and b.kategori_id = 2 order by c.produk_id asc
        `;
            ...
            .then((payload) => {
                ...
                if(cont > 0)
                {
                    ...
                    let query2 = `select 
                        ...
                        left join user_login a on a.user_id = b.fk_user_id
                        where user_fullname = :namefull and b.kategori_id = 2
                        `;
...
exports.listUserMakananbyIddevice = (req, res) => {
    ...
    let { iddevice } = req.body;
        ...
        where ud.iddevice = :iddevicee and b.kategori_id = 2 order by c.produk_id desc
        `;
        ...
        return models.sequelize
            ...
            .then((payload) => {
                ...
                if(cont > 0)
                {
                    ...
                    left join user_login a on a.user_id = b.fk_user_id
                    left join user_devicelog ud on ud.fk_userlogin  = a.user_id 
                    where ud.iddevice = :iddevicee and b.kategori_id = 2 limit 1
                        `;
            ...
            return models.sequelize
                ...
                .then((payload) => {
                    ...
                    if(cont > 0)
                    {
                        ...
                        from product_header b 
                        left join user_login a on a.user_id = b.fk_user_id
                        where user_fullname = :namefull2 and b.kategori_id = 2
                        `;
                        return models.sequelize
                            .query(query2, {
                                replacements: {
                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    return models.product_buahsayur.create({
                                        ...
                                        produk_foto: 'https://dev.tolongbeliin.com/public/upload/tb_merchant/buahsayur/'+filenameproduk+'' || null,
                                    ...
                                    return models.product_header.create({
                                        ...
                                        kategori_id: 2,
                                        kategori_nama: 'BUAHSAYUR' || null,
                                        nama_toko: nama_toko || null,
                                        alamat_toko: alamat_toko || null,
                                        foto: 'https://dev.tolongbeliin.com/public/upload/tb_merchant/buahsayur/'+filenametoko+'' || null,
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_buahsayur.create({
                                                ...
                                                produk_kategori_id: kategori_id_produk || null,
                                                produk_kategori_nama: kategori_nama_produk || null,
                                                produk_foto: 'https://dev.tolongbeliin.com/public/upload/tb_merchant/buahsayur/'+req.files[1].filename+'' || null,
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_buahsayur.update({
                                                produk_nama: nama_produk || null,
                                                produk_harga: harga_produk,
                                                produk_stok: stok_produk || null,
                                                produk_kategori_id: kategori_id_produk || null,
                                            ...
                                            if(dataproduk.length > 0)
                                            {
                                                ...
                                                const savedataproduknoimage = [];
                                                    for(var e=0; e < dataproduk.length; e++)
                                                    {
                                                        ...
                                                        //       produk_foto='${'https://dev.tolongbeliin.com/public/upload/tb_merchant/buahsayur/'+filenameprodukk+'' || null}' 
                                                        ...
                                                        // return models.product_buahsayur.bulkCreate({
                                                        //     produk_nama: dataproduk[e]['nama_produk'] || null,
                                                        //     produk_harga: dataproduk[e]['harga_produk'] || null,
                                                        //     produk_stok: dataproduk[e]['stok_produk'] || null,
                                                        //     produk_kategori_id: dataproduk[e]['kategori_id_produk'] || null,
                                                    ...
                                                    await models.product_buahsayur.bulkCreate(
                                                        savedataproduk,
                                                        {
...
exports.deleteUserMakanan = (req, res) => {
    try {
        ...
        if(produk_id)
        {
            return models.product_buahsayur.destroy({where: {produk_id: produk_id}})
            .then((userdetail2) => {
                if(userdetail2)
                {
