...
exports.listUserMakanan = (req, res) => {
    ...
    //console.log(filterSatu, filterDua, filterTiga);
        ...
        and b.kategori_id = 7 order by c.produk_id asc
        `;
        ...
        return models.sequelize
            ...
            .then((payload) => {
                ...
                if(cont > 0)
                {
                    return success(req, res, payload, "List Produk Matrial", true);
                    ...
                    let query2 = `select 
                        ...
                        left join user_login a on a.user_id = b.fk_user_id
                        where user_fullname = :namefull and b.kategori_id = 7
                        `;
                        ...
                        return models.sequelize
                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    return success(req, res, payload2, "List Produk Matrial", true);
                                }else{
                                    return success(req, res, {}, "List Produk Matrial", true);
                                }
                            })
                            .catch((err) => {
...
exports.listUserMakananbyIddevice = (req, res) => {
    ...
    let { iddevice } = req.body;
        ...
        where ud.iddevice = :iddevicee and b.kategori_id = 7 order by c.produk_id desc
        `;
        ...
        return models.sequelize
            ...
            .then((payload) => {
                ...
                if(cont > 0)
                {
                    ...
                    left join user_login a on a.user_id = b.fk_user_id
                    left join user_devicelog ud on ud.fk_userlogin  = a.user_id 
                    where ud.iddevice = :iddevicee and b.kategori_id = 7 limit 1
                        `;
...
exports.addUserMakanan = (req, res) => {
    try {
        let { fullname, alamat_toko, nama_toko, coordinate, kategori_id_produk, kategori_nama_produk, nama_produk, harga_produk, stok_produk, foto_produk } = req.body;
            ...
            return models.sequelize
                ...
                .then((payload) => {
                    ...
                    if(cont > 0)
                    {
                        ...
                        from product_header b 
                        left join user_login a on a.user_id = b.fk_user_id
                        where user_fullname = :namefull2 and b.kategori_id = 7
                        `;
                        return models.sequelize
                            .query(query2, {
                                replacements: {
                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    return models.product_matrial.create({
                                        ...
                                        produk_foto: 'https://dev.tolongbeliin.com/public/upload/tb_merchant/matrial/'+filenameproduk+'' || null,
                                    ...
                                    return models.product_header.create({
                                        ...
                                        kategori_id: 7,
                                        kategori_nama: 'MATRIAL' || null,
                                        nama_toko: nama_toko || null,
                                        alamat_toko: alamat_toko || null,
                                        foto: 'https://dev.tolongbeliin.com/public/upload/tb_merchant/matrial/'+filenametoko+'' || null,
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_matrial.create({
                                                ...
                                                produk_kategori_id: kategori_id_produk || null,
                                                produk_kategori_nama: kategori_nama_produk || null,
                                                produk_foto: 'https://dev.tolongbeliin.com/public/upload/tb_merchant/matrial/'+req.files[1].filename+'' || null,
        ...
        //     //return res.json({ message: "Delete Produk Matrial Sukses" });
        //     if(err)
        //     {
        ...
        //         console.log(req.files);
        //         //next()
        //         //     return success(req, res, {}, "Tambah Produk Matrial Sukses", true); 
        //         // }
        //         return res.json({ message: "Tambah Produk Matrial Sukses" });
        //     })
        //     //console.log(req.files);
        //     //next()
        //     //     return success(req, res, {}, "Tambah Produk Matrial Sukses", true); 
...
exports.NewUserMakanan = (req, res) => {
    try {
        let { fullname, alamat_toko, nama_toko, coordinate, kategori_id_produk, kategori_nama_produk, nama_produk, harga_produk, stok_produk } = req.body;
...
exports.editUserMakanan = (req, res) => {
    try {
        let { fullname,id_toko, alamat_toko, nama_toko, coordinate, produk_id, kategori_id_produk, kategori_nama_produk, nama_produk, harga_produk, stok_produk, foto_produk } = req.body;
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    .then((userdetail2) => {
                                        if(userdetail2)
                                        {
                                            ...
                                            return models.product_matrial.update({
                                                produk_nama: nama_produk || null,
                                                produk_harga: harga_produk,
                                                produk_stok: stok_produk || null,
                                                produk_kategori_id: kategori_id_produk || null,
                                            ...
                                            .then((userdetail2) => {
                                                if(userdetail2)
                                                {
                                                    return success(req, res, payload2, "Berhasil Edit Produk Matrial", true);
                                                }
                                            })
                                            .catch((err) => {
                                                return error(req, res, {}, "Gagal Silahkan Cobalagi", false, err);
                            ...
                            .then((payload2) => {
                                ...
                                if(cont2 > 0)
                                {
                                    ...
                                    if(filenametoko == "upload_icon.png")
                                    {
                                        ...
                                        dataheaderquery = `
                                        UPDATE tb_merchant.product_header SET 
                                            ...
                                            if(dataproduk.length > 0)
                                            {
                                                ...
                                                const savedataproduknoimage = [];
                                                    for(var e=0; e < dataproduk.length; e++)
                                                    {
                                                        ...
                                                        //       produk_foto='${'https://dev.tolongbeliin.com/public/upload/tb_merchant/matrial/'+filenameprodukk+'' || null}' 
                                                        ...
                                                        // return models.product_matrial.bulkCreate({
                                                        //     produk_nama: dataproduk[e]['nama_produk'] || null,
                                                        //     produk_harga: dataproduk[e]['harga_produk'] || null,
                                                        //     produk_stok: dataproduk[e]['stok_produk'] || null,
                                                        //     produk_kategori_id: dataproduk[e]['kategori_id_produk'] || null,
                                                    ...
                                                    await models.product_matrial.bulkCreate(
                                                        savedataproduk,
                                                        {
...
exports.deleteUserMakanan = (req, res) => {
    try {
        ...
        if(produk_id)
        {
            return models.product_matrial.destroy({where: {produk_id: produk_id}})
            .then((userdetail2) => {
                if(userdetail2)
                {
