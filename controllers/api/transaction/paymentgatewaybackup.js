...
exports.getdatabankLinkqu = (req, res) => {
  ...
  if(username == "beliintolong" && password == "ghaida789")
  {
        ...
        let query = `select * from mref_bank_linkqu where isActive is true`;
...
exports.callbackva = (req, res) => {
    ...
    username,status,signature } = req.body;
      ...
      let querycekva = `select * from tb_merchant.transaction_payment where virtual_account = :nova`;
      ...
      return models.sequelize
          ...
          .then((datatransaksi) => {
              ...
              let querycekmethod = `select * from tb_merchant.callback_payment mbl 
              where mbl.va_number = :idd limit 1`;
                                        ...
                                        if (userdetail4) {
                                          ...
                                          let querydata = `select data.*,
                                            ...
                                            select th.*,
                                                ...
                                                (select dl.firebasetoken from tb_merchant.user_login tbul 
                                                                    left join tb_merchant.user_devicelog dl on dl.fk_userlogin = tbul.user_id
