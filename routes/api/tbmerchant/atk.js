...
let { listUserMakanan, addUserMakanan, editUserMakanan, deleteUserMakanan, listUserMakananbyIddevice, NewUserMakanan, editbatchUserMakanan } = require("../../../controllers/api/tbmerchant/atk");
let { validateUserMakanan, validateDeleteUserMakanan, validateEditUserMakanan, validateIddevice } = require("../../../helpers/validators/tbmerchant/atk");
...
const single = uploads("atk/").any("foto_toko");
