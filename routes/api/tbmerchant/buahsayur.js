...
let { listUserMakanan, addUserMakanan, editUserMakanan, deleteUserMakanan, listUserMakananbyIddevice, NewUserMakanan, editbatchUserMakanan } = require("../../../controllers/api/tbmerchant/buahsayur");
let { validateUserMakanan, validateDeleteUserMakanan, validateEditUserMakanan, validateIddevice } = require("../../../helpers/validators/tbmerchant/buahsayur");
...
const single = uploads("buahsayur/").any("foto_toko");
