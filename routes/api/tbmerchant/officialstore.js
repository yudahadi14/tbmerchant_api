...
let { listUserMakanan, addUserMakanan, editUserMakanan, deleteUserMakanan, listUserMakananbyIddevice, NewUserMakanan,
    editbatchUserMakanan,cekofficialstore, cekkodereferall } = require("../../../controllers/api/tbmerchant/officialstore");
let { validateUserMakanan, validateDeleteUserMakanan, validateEditUserMakanan, validateIddevice } = require("../../../helpers/validators/tbmerchant/officialstore");
...
const single = uploads("officialstore/").any("foto_toko");
...
router.post("/cekofficialstore", cekofficialstore);
router.post("/cekkodereferall", cekkodereferall);
