...
let { listUserMakanan, addUserMakanan, editUserMakanan, deleteUserMakanan, listUserMakananbyIddevice, NewUserMakanan, editbatchUserMakanan } = require("../../../controllers/api/tbmerchant/olahraga");
let { validateUserMakanan, validateDeleteUserMakanan, validateEditUserMakanan, validateIddevice } = require("../../../helpers/validators/tbmerchant/olahraga");
...
const single = uploads("olahraga/").any("foto_toko");
